...
<template>
  ...
  >
    <div
      class="left-container w-4/12 flex flex-col bg-white rounded-lg shadow-md text-center"
    >
      <div class="h-3/6">
      ...
      <div class="flex flex-col items-center h-3/6">
        ...
        >
          ...
          <div class="sm:w-64 sm:h-[240px] flex flex-col justify-around">
            ...
            <table class="w-full text-sm text-left text-gray-500 m-0">
              <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                <tr>
                  ...
                  <th scope="col" class="px-6 py-3 text-center">レベル</th>
                  <th scope="col" class="px-6 py-3 text-center">
                    ミスタイプ数
                  </th>
                  <th scope="col" class="px-6 py-3 text-center">正確率</th>
              ...
              <tbody>
                <tr
                  ...
                  :key="index"
                  class="border-b odd:bg-white even:bg-gray-50 odd:dark:bg-gray-800"
                >
                  <th
                    scope="row"
